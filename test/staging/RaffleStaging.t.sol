...
contract RaffleTest is StdCheats, Test {
    /* Errors */
    event RaffleTest__RequestedRaffleWinner(uint256 indexed requestId);
    event RaffleTest__RaffleEnter(address indexed player);
    event RaffleTest__WinnerPicked(address indexed player);
